export const sectionContentPrivacy = [
  ...
  },
  {
    ...
    contentArray: [
      "3.1 To use our services, you must be at least 18 years old, and have the legal capacity to form a binding legal contract in any relevant jurisdiction. Our services are not intended for individuals under the age of 18. We do not knowingly collect personal information from minors. If you believe that we have inadvertently collected personal information from a minor, please contact us immediately using any of our contact details provided in our website.",
    ],
  },
  {
    id: "4",
    heading: "4. INFORMATION COLLECTED BY US ",
    contentArray: [
      "4.1 We, or our third-party service provider, Persona, on our behalf, collect the following personal information about our customers and users:",
      "(a) contact information (e.g., name, address, phone number, email);",
      "(b) information   we   are   required   to   collect   by   law   under   the   Proceeds   of   Crime   (Money Laundering) and Terrorist Financing Act (PCMLTFA);",
      "(c) Identity documents as required by law (e.g., Government issued identity card);",
      "(d) Photo(s) to compare against provided identity documents (e.g., selfie);",
      "(e) Network identifiers (e.g., IP address or browser information, login information, time zone setting, operating system and platform);(f) Personal information that is requested from you for the use of our website or App.",
      "(g) Details of the transactions you carry out when using our services, including geographic location from which the transaction originates",
      "4.2 We may also collect non-personal information, such as aggregated and anonymized data, which   does   not   directly  identify   you   but   helps   us   improve   our   services   and   enhance   user experience.",
    ],
  },
  {
    id: "5",
  ...
  {
    id: "6",
    heading: "6. HOW YOUR PERSONAL INFORMATION IS USED BY US",
    contentArray: [
      "6.1  Our   primary   purpose   in   collecting   personal   information   is   to   provide   you   with   a   secure, smooth, efficient, and customized experience. We may use your personal information for the following purposes:",
      "(a)  Providing and improving our services, including processing transactions, verifying  identities, and facilitating customer support",
      "(b)  Complying with legal and regulatory obligations, including anti-money laundering  (AML) and know your customer (KYC) requirements",
      "(c)  Protecting against fraud, unauthorized access, and other illegal activities. This may involve sharing with banks, the RMCP and other FINTRAC recognized entities",
      "(d)  Communicating with you regarding our services, updates, promotions, and important notices",
      "(e)  Conducting research and analysis to enhance our services and develop new features",
      "(f)  Aggregating and anonymizing personal information for statistical or research purposes",
    ],
  },
  {
    id: "7",
    heading: "7. DISCLOSURE OF PERSONAL INFORMATION: ",
    contentArray: [
      "7.1. We may share your personal information with third parties in the following circumstances:",
      "(a) Service Providers: We may engage trusted third-party service providers to assist us in delivering our services. These providers have access to personal information only to the  extent necessary to perform their functions on our behalf and are obligated to maintain the    confidentiality and security of your information.",
      "(b) Legal Requirements: We may disclose personal information if required by law, court order, or governmental authority, or if we believe that such disclosure is necessary to protect our rights, property, or safety or that of others.",
      "(c) Business Transfers: In the event of a merger, acquisition, or sale of all or a portion of our assets, personal information may be transferred to the acquiring entity, subject to the same ",
      "(d) Consent: We may share your personal information with your explicit consent.",
    ],
  },
  {
    id: "8",
    heading: "8. MARKETING YOUR INFORMATION",
    contentArray: [
      "8.1   We   neither   sell   nor   rent   your   personal   information   to   third   parties   for   their   marketing purposes without your explicit consent.",
    ],
  },
  {
    id: "9",
  ...
  },
  {
    ...
    contentArray: [
      "11.1. We retain personal information only for as long as necessary to fulfill the purposes outlined   in this Privacy Policy, unless a longer retention period is required or permitted by law. We will   securely dispose of personal information when it is no longer needed.",
    ],
  },
  {
    id: "12",
    ...
    contentArray: [
      "12.1. You have certain rights regarding your personal information, including the right to access, correct,   update,   or   delete   your   information   and   terminate   your   registration   with   Ozone   Pro- Financial Corporation. You may exercise these rights by contacting us using the information provided below.",
    ],
  },
  {
    id: "13",
    ...
    contentArray: [
      "13.1. We may use cookies and similar tracking technologies to enhance your experience on our website or App. These technologies help us collect information about your browsing activities and preferences, allowing us to personalize your user experience and provide targeted advertisements. ",
      "13.2 You may choose to disable cookies through your browser settings, although this may impact certain features of our services.",
    ],
  },
  {
    id: "14",
    ...
    contentArray: [
      " 14.1. We reserve the right to update or modify this Privacy Policy at any time. Any changes will be effective upon posting the revised policy on our website or application. We encourage you to review this Privacy Policy periodically.",
    ],
  },
  {
    id: "15",
    ...
    contentArray: [
      ...
      "\n\n\n +1-825-994-6504",
      "\n\n\n We will endeavor to address your inquiries in a timely manner.",
