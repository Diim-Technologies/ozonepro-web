...
import { sectionContentPrivacy } from "./sectionContent";
        ...
        >
          <Box mb={{ lg: "20px", base: "" }}>
            <Heading
              ...
              w={{ md: "600px", lg: "978px" }}
            >
              Privacy Policy for Ozone Pro-Financial Corporation
            </Heading>
            <Text
              mt={{ lg: "10px" }}
              fontSize="20px"
          ...
          >
            {sectionContentPrivacy[tab]?.heading}
          </Text>
          <Box
            w={{ md: "800px", lg: "978px" }}
            h={{ lg: "450px" }}
          ...
          >
            <Box
              ...
              mr={{ md: "200px" }}
            >
              {sectionContentPrivacy[tab]?.contentArray.map(
                (content, index) => (
                  <Text
                    key={index}
                    fontFamily="body"
